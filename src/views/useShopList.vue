<template>
  <section class="con">
    <figure>
      <figcaption>版本：{{pData.versionNo}} 使用商家列表</figcaption>
      <div class="crumbs">
        <span>商家管理</span>
        <a href="/authVersionList">权限版本管理</a>
        <a>版本：{{pData.versionNo}} 使用商家列表</a>
      </div>
    ...
    <div class="box">
      ...
      <div v-if="dataList">
        共有 {{dataList.total}} 个商家使用 {{pData.versionNo}} 版本
        <table class="tab">
          <tr>
            <th>商家ID</th>
            <th>商家名称</th>
...
export default{
  ...
  data(){
    return{
      pData:{versionId:this.$route.query.versionId, versionNo:this.$route.query.versionNo},
